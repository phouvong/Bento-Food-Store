...
class OrderDetailsScreen extends StatefulWidget {
  ...
  const OrderDetailsScreen({super.key, required this.orderModel, required this.isRunningOrder, this.fromNotification = false});
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<OrderController>(builder: (orderController) {
        ...
        bool showSlider = controllerOrderModel != null ? ((controllerOrderModel.orderStatus == 'pending' /*|| controllerOrderModel.orderStatus == 'accepted'*/)
        ...
        return PopScope(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBarWidget(
              ...
              subTitle: order != null && widget.orderModel.orderStatus != null ? '${'order_is'.tr} ${controllerOrderModel?.orderStatus?.tr ?? widget.orderModel.orderStatus!.tr}' : null,
              menuWidget: InkWell(
                onTap: (){
                  Get.dialog(Dialog(
