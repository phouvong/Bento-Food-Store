                ...
                child: Container(
                  ...
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      subtitle: Text(
                        '${'id'.tr}# ${categories[index].id! > 9 ? categories[index].id : '0${categories[index].id}'}',
                      ...
                      trailing: SizedBox(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          categories[index].childesCount! > 0 ? Container(
                            ...
                            child: Text(
                              categories[index].childesCount.toString(),
                                ...
                                children: [
                                  Row(children: [
                                    ...
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                      child: CustomImageWidget(
                                        image: '${categories?[index].childes![subIndex].imageFullUrl}',
                                        height: 60, width: 65, fit: BoxFit.cover,
                                      ),
                                    ),
                                    ...
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Text(
                                        '${'id'.tr}# ${categories![index].childes![subIndex].id! > 9 ? categories[index].childes![subIndex].id : '0${categories[index].childes![subIndex].id}'}',
                                        style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                                      ),

                                    ])),

                                    categories[index].childes![subIndex].productsCount! > 0 ? Container(
                                      padding: const EdgeInsets.all(8),
                                      decoration: BoxDecoration(
                                      ...
                                      child: Text(
                                        categories[index].childes![subIndex].productsCount.toString(),
